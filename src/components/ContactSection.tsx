...
export default function ContactSection() {
    ...
    const handleSend = () => {
        ...
        const text = `Hello Kalyan,%0A%0AMy name is ${form.name}.%0A%0A${form.message}%0A%0ARegards,%0A${form.name}`;

        const phone = "919985430458";
    ...
    animate-[shine_4s_linear_infinite]"
                            >
                                Looking for a passionate Full Stack Developer?
                                I'm always open to internships, freelance projects,
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-5 mt-2">
                            ...
                            {/* gmail */}
                            <a
                                href="mailto:kalyanpandya91@gmail.com"
  ...
  animate-[headingReveal_1s_cubic-bezier(0.22,1,0.36,1)_0.15s_forwards]"
    ...
    {/* Instagram */}
    <a
        href="https://www.instagram.com/kalyyaan_25?igsh=MWltb3h2ajR1NmtiYQ=="
        target="_blank"
        rel="noopener noreferrer"
    ...
    >
        ...
        <FaInstagram className="relative z-10 text-[30px] text-white transition-all duration-500 group-hover:scale-110" />
    </a>
    ...
    >
        ...
        <FaGithub className="relative z-10 text-[30px] text-white transition-all duration-500 group-hover:scale-110" />
    </a>

    {/* LinkedIn */}
    <a
        href="https://www.linkedin.com/in/kalyan-b-73609329a?utm_source=share_via&utm_content=profile&utm_medium=member_android"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="LinkedIn"
        className="group relative grid h-14 w-14 place-items-center overflow-hidden rounded-[20px]
    ...
    >
        <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 via-cyan-500/10 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
